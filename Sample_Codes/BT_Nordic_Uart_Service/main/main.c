...
#define NUS_SVC_UUID      0x9E, 0xCA, 0xDC, 0x24, 0x0E, 0xE5, 0xA9, 0xE0, 0x93, 0xF3, 0xA3, 0xB5, 0x01, 0x00, 0x40, 0x6E
#define NUS_CHR_RX_UUID   0x9E, 0xCA, 0xDC, 0x24, 0x0E, 0xE5, 0xA9, 0xE0, 0x93, 0xF3, 0xA3, 0xB5, 0x02, 0x00, 0x40, 0x6E
#define NUS_CHR_TX_UUID   0x9E, 0xCA, 0xDC, 0x24, 0x0E, 0xE5, 0xA9, 0xE0, 0x93, 0xF3, 0xA3, 0xB5, 0x03, 0x00, 0x40, 0x6E
...
/* Track handles separately to keep TX and RX routes independent */
static uint16_t ble_spp_tx_char_val_handle; 
static uint16_t ble_spp_rx_char_val_handle;
...
ble_spp_server_advertise(void)
{
    ...
    //     BLE_UUID128_INIT(NUS_SVC_UUID)
    // };
    // fields.num_uuids128 = 1;
    // /* Keep this as 0 to use the default behaviour for this NimBLE build. */
    ...
    fields.uuids128 = BLE_UUID128(BLE_UUID128_DECLARE(NUS_SVC_UUID));
    fields.num_uuids128 = 1;
    fields.uuids128_is_complete = 0;;
...
static int  ble_svc_gatt_handler(uint16_t conn_handle, uint16_t attr_handle, struct ble_gatt_access_ctxt *ctxt, void *arg)
{
    ...
    case BLE_GATT_ACCESS_OP_WRITE_CHR:
        ...
        MODLOG_DFLT(INFO, "Data received in write event,conn_handle = %d,attr_handle = %s", ctxt->om->om_len, ctxt->om->om_data);
        break;
...
static const struct ble_gatt_svc_def new_ble_svc_gatt_defs[] = {
    {
        ...
        .uuid = BLE_UUID128_DECLARE(NUS_SVC_UUID),
        .characteristics = (struct ble_gatt_chr_def[])
        { {
                // TX: Data from ESP32 to phone (Notify)
                .uuid = BLE_UUID128_DECLARE(NUS_CHR_TX_UUID),
                .access_cb = ble_svc_gatt_handler,
                .flags = BLE_GATT_CHR_F_NOTIFY,
                .val_handle = &ble_spp_svc_gatt_read_val_handle, // Handle used to send data
                
            }, {
                /* Support SPP service */
                .uuid = BLE_UUID128_DECLARE(NUS_CHR_RX_UUID),
                .access_cb = ble_svc_gatt_handler,
...
#if 1
/* Define new custom service - FIXED */
static const struct ble_gatt_svc_def new_ble_svc_gatt_defs[] = {
    {
        /*** Service: SPP */
        .type = BLE_GATT_SVC_TYPE_PRIMARY,
        ...
        { {
                ...
                .access_cb = ble_svc_gatt_handler,
                .flags = BLE_GATT_CHR_F_NOTIFY,
                /* FIX 1: Point to its own dedicated handle variable */
                .val_handle = &ble_spp_tx_char_val_handle, 
                
            }, {
                /* RX: Data from phone to ESP32 */
                .uuid = BLE_UUID128_DECLARE(NUS_CHR_RX_UUID),
                .access_cb = ble_svc_gatt_handler,
                /* FIX 2: Separate the incoming write tracking destination */
                .val_handle = &ble_spp_rx_char_val_handle,
                .flags = BLE_GATT_CHR_F_WRITE | BLE_GATT_CHR_F_WRITE_NO_RSP,
            }, {
                0, /* No more characteristics */
            }
                ...
                if (event.size) {
                    ...
                    for (int i = 0; i <= CONFIG_BT_NIMBLE_MAX_CONNECTIONS; i++) {
                        ...
                        if (conn_handle_subs[i]) {
                            ...
                            rc = ble_gatts_notify_custom(i, ble_spp_tx_char_val_handle,
                                                         txom);
                            if (rc == 0) {
